...
<div class="bg p30">
    ...
    <div class='w1000 center route'>
        <span>您的位置：</span><a href="/">首页</a> <span> > </span><a href="#">案例分享</a>
    </div>

    <?php
 $tag = 'cid:5;order:post_date desc'; $posts = sp_sql_posts_paged($tag,2); ?>
    <div class="case-content w1000 center ">
        <?php if(is_array($posts['posts'])): foreach($posts['posts'] as $key=>$vo): ?><div class="case-item clearfix">
                ...
                <div class="fr item">
                    ...
                    <div>
                        <a class="detail" href="/index.php?g=portal&m=index&a=detail&pid=<?php echo ($vo["object_id"]); ?>">详细>></a>
                    </div>
                </div>
